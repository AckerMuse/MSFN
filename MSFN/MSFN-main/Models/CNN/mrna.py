...
clin = pd.read_csv("../../Data/mRNA_400.csv", index_col=False, header=None).astype('float').values
...
np.savetxt("../../Outputs/mRNA_feature.csv",stacked_feature,delimiter=',')
